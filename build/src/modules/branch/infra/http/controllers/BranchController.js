...
const CreateBranchService_1 = __importDefault(require("../../../services/CreateBranchService"));
const ShowBranchService_1 = __importDefault(require("../../../services/ShowBranchService"));
const UpdateBranchService_1 = __importDefault(require("../../../services/UpdateBranchService"));
const DeleteBranchService_1 = __importDefault(require("../../../services/DeleteBranchService"));
const ListRootBranchesService_1 = __importDefault(require("../../../services/ListRootBranchesService"));
class BranchController {
    ...
    async create(request, response) {
        ...
        return response.json(await createBranchService.execute({ ...data, user: { id: id } }));
    }
