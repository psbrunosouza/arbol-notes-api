...
const ListImageService_1 = __importDefault(require("../../../services/ListImageService"));
const CreateImageService_1 = __importDefault(require("../../../services/CreateImageService"));
const ShowImageService_1 = __importDefault(require("../../../services/ShowImageService"));
const UpdateImageService_1 = __importDefault(require("../../../services/UpdateImageService"));
const DeleteImageService_1 = __importDefault(require("../../../services/DeleteImageService"));
