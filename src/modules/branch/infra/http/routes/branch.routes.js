...
const BranchController_1 = __importDefault(require("@modules/branch/infra/http/controllers/BranchController"));
const branch_schema_1 = require("@modules/branch/schemas/branch.schema");
