...
const ListCategoryService_1 = __importDefault(require("@modules/category/services/ListCategoryService"));
const CreateCategoryService_1 = __importDefault(require("@modules/category/services/CreateCategoryService"));
const ShowCategoryService_1 = __importDefault(require("@modules/category/services/ShowCategoryService"));
const UpdateCategoryService_1 = __importDefault(require("@modules/category/services/UpdateCategoryService"));
const DeleteCategoryService_1 = __importDefault(require("@modules/category/services/DeleteCategoryService"));
