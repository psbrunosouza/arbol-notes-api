...
const ImageController_1 = __importDefault(require("@modules/image/infra/http/controllers/ImageController"));
const image_schema_1 = require("@modules/image/schemas/image.schema");
