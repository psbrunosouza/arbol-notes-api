...
const ListProfileService_1 = __importDefault(require("@modules/profile/services/ListProfileService"));
const CreateProfileService_1 = __importDefault(require("@modules/profile/services/CreateProfileService"));
const ShowProfileService_1 = __importDefault(require("@modules/profile/services/ShowProfileService"));
const UpdateProfileService_1 = __importDefault(require("@modules/profile/services/UpdateProfileService"));
const DeleteProfileService_1 = __importDefault(require("@modules/profile/services/DeleteProfileService"));
